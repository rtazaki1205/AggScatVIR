...
class dustmodel:
    ...
    def __init__(self,partype=None,size=None,comp=None,amon=None,dist=True,chop='nochop',smatBH=False,filename=None,quiet=False):
        """
        ...
        # print warning when reading models with incomplete wavelength coverage
        if self.nlmd==5 and quiet==False:
            print('Warning: Reading a dust model with incomplete wavelength grids:',self.lmd)
...
class distaverage:
    ...
    def __init__(self,partype,sizemin,sizemax,comp,amon=None,powind=3.5,chopang=0.0,smatBH=False):
        ...
        if self.aggop:
            ...
            ssmin=dustmodel(partype=partype,size=str(2**imin),amon=amon,comp=comp,dist=False,quiet=True)
            ssmax=dustmodel(partype=partype,size=str(2**imax),amon=amon,comp=comp,dist=False,quiet=True)
            ...
            ssmin=dustmodel(partype='grs',size=grs_list[imin],comp=comp,dist=False,quiet=True)   
            ssmax=dustmodel(partype='grs',size=grs_list[imax],comp=comp,dist=False,quiet=True)   
            self.rhomat=ssmax.rhomat
...
def dustspec_header(self,specoutput=None,outfmt=None,opacity=None):
    ...
    version = pkg_resources.require("aggscatpy")[0].version

    print('#============================================================================',file=specoutput)
    print('# Generated by aggscatpy v'+version+' in AggScatVIR                          ',file=specoutput)
